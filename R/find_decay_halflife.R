...
#'
#' The notion of this function is to find the largest half-life that yields a almost-zero decay
#' factor (as per `tol` argument) at `grid_end`.
#'
...
#' @param tol scalar, the proportion of the original HRQoL that corresponds to zero (the default
#'   value corresponds to considering `<5%` of the starting HRQoL to be the same as `0`)
#'
#' @keywords internal
